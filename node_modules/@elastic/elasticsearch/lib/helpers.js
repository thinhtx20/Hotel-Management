...
class Helpers {
    ...
    bulk(options, reqOptions = {}) {
        ...
        onSuccess, onFlush, refreshOnCompletion = false, ...bulkOptions } = options;
    ...
    esql(params, reqOptions = {}) {
        ...
        const helper = {
            ...
            async toArrowReader() {
                ...
                reqOptions.meta = true;
                const result = await client.esql.query(params, reqOptions);
