...
const cancel_reindex_1 = tslib_1.__importDefault(require("./api/cancel_reindex"));
...
const encryption_1 = tslib_1.__importDefault(require("./api/encryption"));
...
const get_reindex_1 = tslib_1.__importDefault(require("./api/get_reindex"));
...
const list_reindex_1 = tslib_1.__importDefault(require("./api/list_reindex"));
...
class API {
    constructor() {
        ...
        Object.defineProperty(this, _19, {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
_a = kAsyncSearch, _b = kAutoscaling, _c = kCat, _d = kCcr, _e = kCluster, _f = kConnector, _g = kDanglingIndices, _h = kEncryption, _j = kEnrich, _k = kEql, _l = kEsql, _m = kFeatures, _o = kFleet, _p = kGraph, _q = kIlm, _r = kIndices, _s = kInference, _t = kIngest, _u = kLicense, _v = kLogstash, _w = kMigration, _x = kMl, _y = kMonitoring, _z = kNodes, _0 = kProfiling, _1 = kProject, _2 = kQueryRules, _3 = kRollup, _4 = kSearchApplication, _5 = kSearchableSnapshots, _6 = kSecurity, _7 = kShutdown, _8 = kSimulate, _9 = kSlm, _10 = kSnapshot, _11 = kSql, _12 = kSsl, _13 = kStreams, _14 = kSynonyms, _15 = kTasks, _16 = kTextStructure, _17 = kTransform, _18 = kWatcher, _19 = kXpack;
exports.default = API;
API.prototype.bulk = bulk_1.default;
API.prototype.cancelReindex = cancel_reindex_1.default;
...
API.prototype.getReindex = get_reindex_1.default;
...
API.prototype.listReindex = list_reindex_1.default;
...
Object.defineProperties(API.prototype, {
    ...
    encryption: {
        get() { return this[kEncryption] === null ? (this[kEncryption] = new encryption_1.default(this.transport)) : this[kEncryption]; }
    },
    enrich: {
