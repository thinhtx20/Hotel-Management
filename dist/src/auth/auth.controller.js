...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Đã gửi mã OTP về email (hoặc ghi log dev)' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Email không hợp lệ' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Xác thực thành công, trả về resetToken' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Mã OTP không chính xác hoặc hết hạn' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Thông tin xác thực không hợp lệ hoặc hết hạn' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Thông tin tài khoản' }),
