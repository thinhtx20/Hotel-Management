...
let PrismaService = PrismaService_1 = class PrismaService extends client_1.PrismaClient {
    ...
    async ensureInitialSeed() {
        try {
            ...
            const roomsConfig = [
                { roomNumber: '101', floor: 1, typeCode: 'STD-S', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '102', floor: 1, typeCode: 'STD-S', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '103', floor: 1, typeCode: 'STD-D', status: client_1.RoomStatus.OCCUPIED },
                { roomNumber: '104', floor: 1, typeCode: 'STD-D', status: client_1.RoomStatus.CLEANING, notes: 'Đang dọn phòng' },
                { roomNumber: '201', floor: 2, typeCode: 'SUP-CV', status: client_1.RoomStatus.OCCUPIED },
                { roomNumber: '202', floor: 2, typeCode: 'SUP-CV', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '203', floor: 2, typeCode: 'SUP-CV', status: client_1.RoomStatus.RESERVED, notes: 'Khách cọc nhận phòng hôm nay' },
                { roomNumber: '204', floor: 2, typeCode: 'SUP-CV', status: client_1.RoomStatus.MAINTENANCE, notes: 'Bảo trì thay vòi sen' },
                { roomNumber: '301', floor: 3, typeCode: 'DLX-OV', status: client_1.RoomStatus.OCCUPIED },
                { roomNumber: '302', floor: 3, typeCode: 'DLX-OV', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '303', floor: 3, typeCode: 'DLX-OV', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '304', floor: 3, typeCode: 'DLX-OV', status: client_1.RoomStatus.CLEANING, notes: 'Khử trùng sau trả phòng' },
                { roomNumber: '401', floor: 4, typeCode: 'SUI-EXEC', status: client_1.RoomStatus.OCCUPIED },
                { roomNumber: '402', floor: 4, typeCode: 'SUI-EXEC', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '403', floor: 4, typeCode: 'SUI-EXEC', status: client_1.RoomStatus.RESERVED, notes: 'Đoàn công tác đối tác' },
                { roomNumber: '404', floor: 4, typeCode: 'SUI-EXEC', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '501', floor: 5, typeCode: 'PRE-VIP', status: client_1.RoomStatus.AVAILABLE },
                { roomNumber: '502', floor: 5, typeCode: 'PRE-VIP', status: client_1.RoomStatus.RESERVED, notes: 'Đặt tiệc sinh nhật cuối tuần' },
            ];
            const roomsMap = {};
